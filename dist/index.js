...
const SocialBrowserDetector = ({ className = "", customText, debugMode = false, }) => {
    ...
    return (_jsx("div", { className: `fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 ${className}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "popup-title", children: _jsxs("div", { className: "bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl w-full max-w-sm mx-auto p-6 animate-in fade-in duration-200 overflow-hidden", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { id: "popup-title", className: "text-lg font-semibold text-gray-900 dark:text-gray-100 pr-2 truncate", children: text.title }), _jsx("button", { onClick: handleClose, className: "text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 flex-shrink-0", "aria-label": "Close popup", children: _jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] }), _jsxs("div", { className: "mb-6", children: [_jsx("p", { className: "text-gray-600 dark:text-gray-300 text-sm mb-4 break-words", children: text.description }), _jsxs("div", { className: "bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4", children: [_jsxs("p", { className: "text-blue-800 dark:text-blue-200 text-sm font-medium mb-3 flex items-center", children: [_jsx("svg", { className: "w-4 h-4 mr-2 flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) }), _jsx("span", { className: "break-words", children: text.howToTitle })] }), _jsxs("ol", { className: "text-blue-700 dark:text-blue-300 text-sm space-y-2", children: [_jsxs("li", { className: "flex items-start", children: [_jsx("span", { className: "bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium mr-3 mt-0.5 flex-shrink-0", children: "1" }), _jsxs("span", { className: "break-words", children: ["Tap the ", _jsx("strong", { children: "three dots (\u22EF)" }), " in the top right corner"] })] }), _jsxs("li", { className: "flex items-start", children: [_jsx("span", { className: "bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200 rounded-full w-5 h-5 flex items-center justify-center text-xs font-medium mr-3 mt-0.5 flex-shrink-0", children: "2" }), _jsxs("span", { className: "break-words", children: ["Select ", _jsx("strong", { children: "\"Open in External Browser\"" }), " or", " ", _jsx("strong", { children: "\"Open in Chrome/Safari\"" })] })] })] })] })] }), _jsx("div", { className: "flex justify-end", children: _jsx("button", { onClick: handleClose, className: "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 px-4 py-3 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 active:bg-gray-300 dark:active:bg-gray-500 transition-colors", children: text.continueButton }) })] }) }));
};
